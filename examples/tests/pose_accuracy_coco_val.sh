...
JSON_FOLDER=./evaluation/coco_val_jsons/opencl_656x368_3_0.25_200
OP_BIN=./build_opencl/examples/openpose/openpose.bin
...
#     # 4 scales
$OP_BIN  --image_dir $IMAGE_FOLDER --write_coco_json ${JSON_FOLDER}.json --no_display --render_pose 1 --scale_number 3 --scale_gap 0.25 --net_resolution "656x368"  --frame_last 200
