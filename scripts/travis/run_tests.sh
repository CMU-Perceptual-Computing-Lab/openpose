...
if [[ $RUN_EXAMPLES == true ]] ; then
  ...
  if [[ $WITH_PYTHON == true ]] ; then
    ...
    cd build/examples/tutorial_api_python; python3 openpose_python.py --net_resolution -1x32 --image_dir ../../../examples/media/ --write_json output/ --display 0 --render_pose 0
    echo " "
  fi
