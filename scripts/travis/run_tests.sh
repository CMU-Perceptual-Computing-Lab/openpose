...
if [[ $RUN_EXAMPLES == true ]] ; then
  ...
  # # Note: Examples 1-5 and 9 require GUI
  # echo "Tutorial API C++: Examples 1-5 and 9..."
  ...
  ./build/examples/tutorial_api_cpp/8_synchronous_custom_output.bin --net_resolution -1x32 --image_dir examples/media/ --write_json output/ --display 0 --render_pose 0
  echo " "
