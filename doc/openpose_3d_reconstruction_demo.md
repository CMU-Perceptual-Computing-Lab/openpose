...
## Camera Calibration
The user must manually get the intrinsic and extrinsic parameters of the cameras, introduce them on: `include/experimental/3d/cameraParameters.hpp`, and recompile OpenPose.
